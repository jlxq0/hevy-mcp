...
//!
//! hevy-mcp validates Logto access tokens locally: fetch the
...
//! which is how hevy-mcp's protected-resource metadata steers claude.ai.
...
pub struct AuthenticatedIdentity {
    ...
    pub user_id: String,
    /// User's email, when the token carries it.
