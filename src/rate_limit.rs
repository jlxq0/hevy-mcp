...
//!
//! 1. `sha256(bearer)[..16]` — contains the impact of a leaked
...
//!    the union of their per-token allowances to flood Hevy.
//!
...
//! ## Why two quotas
//!
//! Reads are idempotent and get the higher default quota. Writes are
//! side-effectful and get the tighter quota.
//!
//! ## Memory bound
//!
...
//! is small for hevy-mcp's threat model (single tenant today, dozens
...
//! `config.rs`:
//!
//! - `HEVY_MCP_RATE_LIMIT_READS_PER_MIN` (default 60)
//! - `HEVY_MCP_RATE_LIMIT_WRITES_PER_MIN` (default 30)
